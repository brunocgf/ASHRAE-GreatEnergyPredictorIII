...
X_train, y_train = train_boost7()
print(X_train.head())
mod_boost7 = GradientBoostingRegressor(max_depth=15)
mod_boost7.fit(X_train, y_train.values.ravel())
print(mod_boost7.feature_importances_)
...
with open("tree7.pkl", "wb") as f:
     pickle.dump(mod_boost7, f)
