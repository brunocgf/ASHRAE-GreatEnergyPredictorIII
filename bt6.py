...
print(X_train.head())
mod_boost6 = GradientBoostingRegressor(max_depth=12)
mod_boost6.fit(X_train, y_train.values.ravel())


#with open("tree6.pkl", "wb") as f:
#     pickle.dump(mod_boost6, f)
...
print(mod_boost6.feature_importances_)
...
sub.to_csv('./submissionboost6.csv')