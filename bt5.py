...
def train_boost4():
    ...
    # Elimina outliers
    train.loc[(train['meter_reading']>100000),'meter_reading'] = np.NaN
...
X_train, y_train = train_boost4()
mod_boost4 = GradientBoostingRegressor(max_depth=10)
mod_boost4.fit(X_train, y_train.values.ravel())
print(mod_boost4.feature_importances_)
...
#with open("tree4rev.pkl", "wb") as f:
#     pickle.dump(mod_boost4, f)
...
sub.to_csv('./submissionboost5.csv')